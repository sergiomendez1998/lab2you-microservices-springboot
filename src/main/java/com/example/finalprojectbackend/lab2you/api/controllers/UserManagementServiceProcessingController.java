...
public class UserManagementServiceProcessingController {
    ...
    // public ResponseEntity<String> registerUserFromAdminRequest(@RequestBody
    // UserDTO userDTO) {
    // try {
    ...
    // } catch (Exception e) {
    // return
    // ResponseEntity.badRequest().body(Lab2YouConstants._LAB2YOU_REASON_CODE_UNEXPECTED_EXCEPTION);
    // }
    // }
    ...
    // public ResponseEntity<String> registerUserFromMedicalRequest(@RequestBody
    // UserDTO userDTO) {
    // try {

    // Role role =
    // roleService.findByName(Lab2YouConstants.lab2YouRoles.USER.getRole());
    ...
    // if (newUser != null) {
    // return
    // ResponseEntity.badRequest().body(Lab2YouConstants.lab2YouErrorCodes.USER_ALREADY_EXISTS.getDescription());
    // }
    ...
    // return
    // ResponseEntity.badRequest().body(Lab2YouConstants.lab2YouErrorCodes.INVALID_DATA.getDescription()
    // +
    ...
    // return
    // ResponseEntity.ok().body(Lab2YouConstants.lab2YouSuccessCodes.EMAIL_SENT.getDescription());
    // }
